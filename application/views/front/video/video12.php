...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value="Why do you think it is important to be able to view one situation from different perspectives??" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value=" To know that we are not always right">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value="To make better decisions in future">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="To enable our kids to do the same and be compassionate and empathetic towards others
...
who are different from us
  ...
  <tr style="display: none;">
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="If they are not naturally attentive they will never be">
   </td>
   <td style="width:96%;height:30px"  >
