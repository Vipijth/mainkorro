...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value=" How can make our kids attentive?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value="Yell at them when they don’t pay attention">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value=" Make them a part of mindfulness training">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value=" Let them be on their own">
   </td>
   <td style="width:96%;height:30px" >
