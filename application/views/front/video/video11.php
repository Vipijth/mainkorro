...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value="Why is finding what’s sacred for your kid important?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value="To help them perform well in exams">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value=" To enable a purposeful being">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="To help them become wealthy in future">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value=" To make them excel in athletics">
   </td>
   <td style="width:96%;height:30px"  >
