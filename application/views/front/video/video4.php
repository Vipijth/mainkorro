...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value=" What is the best way to face a challenge or a negative situation?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value="Run away from it">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value=" Avoid it">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="Face it with all your inner resources to help you remain resilient">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="  Let time solve the problem">
   </td>
   <td style="width:96%;height:30px"  >
