...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value="How can we focus on essential socio-emotional development in young students?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value=" By making them memorize lessons">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value="By inculcating life values and sharing real-life experiences">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="By taking more standardized tests">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="By making them read more books">
   </td>
   <td style="width:96%;height:30px"  >
