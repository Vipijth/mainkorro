...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value="What is the leading cause of depression?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value="Loneliness">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value="Shredded connections">
   </td>
