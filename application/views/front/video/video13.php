...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value="What part of the brain is associated with day-dreaming?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio" id="first" value="Rear part">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value="Front part">
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="Middle part">
   </td>
   <td style="width:96%;height:30px" >
   Middle part
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="All of the brain">
   </td>
   <td style="width:96%;height:30px"  >
 All of the brain
     </td>
