...
1
 ...
 <input type="hidden"    name="question_name1" id="question_name1" value="Neuroplastic changes stop at what age?" >
   ...
   <tr>
    ...
    <input type="radio" onchange="en1()"  required name="radio"  id="first" value=" After 12">
   ...
   <tr>
    <td style="padding:4px 16px">
   <input type="radio" required  onchange="en1()"  name="radio" id="first" value="After 18" >
   </td>
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first" value="It varies from one person to another">
   </td>
   <td style="width:96%;height:30px" >
  ...
  <tr>
    <td style="padding:4px 16px">
   <input type="radio" onchange="en1()"   required name="radio" id="first"  value="It never stops but slows down gradually">
   </td>
   <td style="width:96%;height:30px"  >
